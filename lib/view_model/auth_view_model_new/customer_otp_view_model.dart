...
// ─────────────────────────────────────────────────────────────────────────────
// All service bootstrapping (Socket, SSE, OneSignal) is intentionally removed.
// NavigationScreen._initServices() owns and manages all of them on mount.
// This ViewModel only saves credentials and navigates.
// ─────────────────────────────────────────────────────────────────────────────
...
class AuthOtpVerifyViewModel with ChangeNotifier {
  ...
  Future<void> authOtpVerify(dynamic data, BuildContext context) async {
    ...
    try {
      ...
      setAuthOTPVerifyloading(false);
      if (kDebugMode) print('🔥 OTP Verify Error: $error');
      _handleError(error, context);
    }
  }
