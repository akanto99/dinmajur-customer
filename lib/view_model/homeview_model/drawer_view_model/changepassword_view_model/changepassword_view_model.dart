...
import 'package:dinmajur_customer/respository/home_repositories/drawer_repository/changepassword_repository/changepassword_repository.dart';
...
class PostChangePasswordViewModel with ChangeNotifier {
  ...
  Future<void> changePasswordPostApi(BuildContext context, dynamic fields,) async {
    ...
    try {
      ...
      setCreatePostChangePasswordLoading(false);
      Utils.flushBarSuccessMessage('পাসওয়ার্ড সফলভাবে পরিবর্তন হয়েছে', context);
