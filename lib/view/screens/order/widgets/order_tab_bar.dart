...
class OrderTabBar extends StatelessWidget {
  ...
  const OrderTabBar({super.key, required this.selectedIndex, required this.onTabChanged});
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Row(mainAxisAlignment: MainAxisAlignment.center, children: List.generate(_tabs.length, (index) => _buildTab(context, _tabs[index], index, screenWidth))),
    );
  }
