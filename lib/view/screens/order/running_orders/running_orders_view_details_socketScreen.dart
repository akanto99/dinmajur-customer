...
class RunningOrdersViewDetailsSocketscreen extends StatefulWidget {
  final String orderId;
  const RunningOrdersViewDetailsSocketscreen({Key? key, required this.orderId}) : super(key: key);

  @override
  State<RunningOrdersViewDetailsSocketscreen> createState() => _RunningOrdersViewDetailsSocketscreenState();
}

class _RunningOrdersViewDetailsSocketscreenState extends State<RunningOrdersViewDetailsSocketscreen> with WidgetsBindingObserver{
  int _currentStep = 0;
