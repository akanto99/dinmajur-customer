...
//   Future<void> initializeSSE(String userId, NotificationViewModel notificationViewModel) async {
//     _notificationViewModel = notificationViewModel;
//     _sseService = SSENotificationService();
//
//     try {
//       await _sseService!.startListening(userId);
//       notificationViewModel.initializeNotificationListener(_sseService!.notificationStream);
//
//       debugPrint('✅ SSE initialized for user: $userId');
//     } catch (e) {
//       debugPrint('❌ Failed to initialize SSE: $e');
//     }
//   }
//
//   // Stop SSE
