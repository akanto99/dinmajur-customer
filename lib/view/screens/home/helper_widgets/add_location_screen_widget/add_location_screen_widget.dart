...
// ✅ Handle Save and Continue - Return selected address data
  void _handleSaveAndContinue() {
    ...
    if (_selectedLocationId != null && _selectedLocationData != null) {
      ...
      // ✅ User typed a new address - Include city in full address
      String fullAddressWithCity = '${_addressController.text.trim()}, $_selectedCity'; // ✅ Added city

      selectedAddressData = {
        'addressType': 'new',
        'locationId': null,
        'fullAddress': fullAddressWithCity, // ✅ Now includes city
        'city': _selectedCity,
        'coordinates': [],
      };

      print('✅ New Address Entered:');
      print('   - Full Address: $fullAddressWithCity');
      print('   - City: $_selectedCity');
    }
