...
class DynamicCartServicelistWidget extends StatefulWidget {
  ...
  const DynamicCartServicelistWidget({
    Key? key,
  ...
  @override
  State<DynamicCartServicelistWidget> createState() => _DynamicCartServicelistWidgetState();
}

class _DynamicCartServicelistWidgetState extends State<DynamicCartServicelistWidget> {
  int _getTotalItems() {
