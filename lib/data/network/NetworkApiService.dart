...
class NetworkApiService extends BaseApiServices {
  ...
  Future<dynamic> getGetApiWithHeaderResponse(String url, {Map<String, String>? headers}) async {
    ...
    try {
      ...
      responseJson = await _handleResponse(
          response,
          url,
  ...
  @override
  Future getPatchApiImageResponse(
      String url,
      String fileName,
      Uint8List imageBytes,
      {
    ...
    try {
      ...
      responseJson = await _handleResponse(
          response,
          url,
              () => getPatchApiImageResponse(url, fileName, imageBytes, headers: headers)
      );
    } on SocketException {
      throw FetchDataException('No Internet Connection');
    } on TimeoutException {
  ...
  Future getPatchApiImageCoverResponse(
    ...
    try {
      ...
      responseJson = await _handleResponse(
          response,
          url,
              () => getPatchApiImageCoverResponse(url, fileName, imageBytes, imageType, headers: headers)
      );
    } on SocketException {
      throw FetchDataException('No Internet Connection');
    } on TimeoutException {
  ...
  @override
  Future<dynamic> getPatchApiDocumentPDFImageResponse(
      String url,
      Uint8List pdfImageBytes,
      String documentType,
      String fileName,
    ...
    try {
      ...
      return await _handleResponse(
          response,
          url,
              () => getPatchApiDocumentPDFImageResponse(url, pdfImageBytes, documentType, fileName, headers: headers)
      );
    } on SocketException {
      throw FetchDataException('No Internet Connection');
    } on TimeoutException {
