class AppUrl {
  // static var baseUrl = 'https://58cc-103-153-170-227.ngrok-free.app/api/v1' ;// Staging Server
  // static var socketUrl = 'https://58cc-103-153-170-227.ngrok-free.app' ;// Staging
